...
| `surgery_rt_synergy_plot.py` | Evaluates the compound risk interaction specifically between axillary surgery and radiotherapy. | `surgery_rt_synergy.png` |
| `molecular_subtype_risk_analysis.py` | Classifies patients using the St. Gallen Criteria and analyzes lymphedema prevalence across biological phenotypes. | `molecular_subtype_risk.png` |
...
| `bmi_risk_logistic_regression.py` | Fits logistic regression curves to map continuous BMI risk progression. | `bmi_surgical_threshold.png` |
